...
The function `res.comp` calculates the resilience components resistance, recovery, resilience and relative resilience. As the component *resistance* is conceptually identical to the relative growth change method applied for years with low growth (i.e. the ratio of tree growth during and before disturbance), thresholds for negative event and pointer years can be set as in `pointer.rgc`.
